...
namespace Ildasm
{
    sealed partial class Disassembler : IComparer<ExceptionHandlingClause>
    {
            ...
            while (pos < code.Length)
            {
                ...
                switch (opcode.OperandType)
                {
                    ...
                    case OperandType.InlineType:
                        ...
                        WriteInlineType(lw, ResolveType(ReadInt32(code, ref pos), genericTypeArguments, genericMethodArguments));
                        break;
        ...
        void WriteInlineMethod(LineWriter lw, MethodBase mb, Type[] optionalParameterTypes, CustomModifiers[] customModifiers, MethodInfo methodimpl = null)
        {
            ...
            {
                WriteSignatureType(lw, ((MethodInfo)mb.__GetMethodOnTypeDefinition()).ReturnType, mb.DeclaringType != null && mb.DeclaringType.IsArray ? TypeLocation.General : TypeLocation.MemberRef);
            ...
            if (mb.IsGenericMethod)
            {
                ...
                else
                {
                    ...
                    foreach (var par in mb.GetGenericArguments())
                    {
                        lw.Write(sep);
                        sep = ",";
                        WriteSignatureType(lw, par, generic ? TypeLocation.MemberRef : TypeLocation.MethodGenericParameter);
                    }
                    lw.Write(">");
                }
            }
            ...
            TypeLocation loc = (methodimpl != null && mb.IsGenericMethod)
                ...
                : (mb.DeclaringType != null && mb.DeclaringType.IsArray) ? TypeLocation.General : TypeLocation.MemberRef;
            int level = lw.Column;
        ...
        void WriteInlineType(LineWriter lw, Type type)
        {
        ...
        {
            WriteSignatureType(lw, field.__GetFieldOnTypeDefinition().FieldType, TypeLocation.MemberRef);
